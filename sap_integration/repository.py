...
from sap_integration.jobs import read_outbound_FI09_and_update_table_job
...
from sap_integration.schedules.schedule_outbound_FI09 import schedules_outbound_FI09
from sap_integration.schedules.schedule_outbound_FI10 import schedules_outbound_FI10
from sap_integration.schedules.schedule_outbound_FI15 import schedules_outbound_FI15
...
@repository
def read_outbound_FI09_repo():
    return [read_outbound_FI09_and_update_table_job, schedules_outbound_FI09]

@repository
def read_outbound_FI10_repo():
    return [read_outbound_FI10_and_update_table_job, schedules_outbound_FI10]

@repository
def read_outbound_FI15_repo():
    return [read_outbound_FI15_and_update_table_job, schedules_outbound_FI15]
